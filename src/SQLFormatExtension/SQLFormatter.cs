...
namespace SQLFormatExtension
{
    public class SQLFormatter
    {
        ...
        private static readonly Regex NonQuotedVariableName = new Regex("^(@[a-zA-Z0-9\\._\\$]+)");
        private static readonly Regex Number;
        private static readonly Regex Boundary;
        private static readonly Regex ReservedTopLevelExpr;
        private static readonly Regex Newline;
        private static readonly Regex ReservedExpr;
